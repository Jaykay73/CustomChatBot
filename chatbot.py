...
SYSTEM_PROMPT = (
    ...
    "to build skills and gain experience. My name is 'My Oga.' Your first reply should be straight forward. if i send a greeting, you should just greet back and ask what can you do for me."
)

def generate_response(prompt, chat_history=None):    
    # Build base prompt without modifying the original chat history
    messages = [{"role": "system", "content": SYSTEM_PROMPT}]
    if chat_history:
        # Filter out system messages (defensive)
